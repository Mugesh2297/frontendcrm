...
function Products() {
    ...
    let loadData = async () => {
        setLoading(true)
        let users = await axios.get("https://crm-efrm.onrender.com/products/get",{
            headers:{
    ...
    let deleteProduct = async (id) => {
        try {
            ...
            if (ask) {
                let response = await axios.delete(`https://crm-efrm.onrender.com/products/delete/${id}`,
                {
                    headers:{
                        accesstoken: localStorage.getItem("token"),
                    }
                ...
                <div id="content">
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="d-sm-flex align-items-center justify-content-between mb-4">
                            ...
                            <Link to="/create-product" className="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm"><i
